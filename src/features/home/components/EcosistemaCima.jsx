            ...
            <div className="flex flex-col w-full h-auto  mx-30 justify-center items-center">
                ...
                <div className="grid grid-cols-3 grid-rows-2 shadow-xl border border-gray-300">
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center bg-blue-primaryCima text-white  2xl:h-auto ">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/simplificar.png" alt="imagen de simplificacion" />
                    ...
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center text-blue-primaryCima  bg-white  2xl:h-auto">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/business-intelligence.png" alt="" />
                    ...
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center bg-blue-primaryCima text-white  2xl:h-auto">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/aumento.png" alt="" />
                    ...
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center  text-blue-primaryCima  bg-white  2xl:h-auto">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/visibilidad.png" alt="" />
                    ...
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center  bg-blue-primaryCima text-white  2xl:h-auto">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/megafono.png" alt="" />
                    ...
                    <article className="flex h-auto w-auto p-8 gap-5 flex-col items-center justify-center  text-blue-primaryCima  bg-white  2xl:h-auto">
                        <img loading="lazy" className="w-22" src="src/assets/icons/icons_ecosistema/actuacion.png" alt="" />
